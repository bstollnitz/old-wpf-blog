...
namespace CustomControls
{
    ...
    public class LabeledPieChart : Control
    {
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register("Title", typeof(object), typeof(LabeledPieChart), new PropertyMetadata(String.Empty));
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof(IEnumerable), typeof(LabeledPieChart), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IsSelectionEnabledProperty =
            DependencyProperty.Register("IsSelectionEnabled", typeof(bool), typeof(LabeledPieChart), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register("SelectedItem", typeof(object), typeof(LabeledPieChart), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty PieChartLabelStyleProperty =
            DependencyProperty.Register("PieChartLabelStyle", typeof(Style), typeof(LabeledPieChart), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty PieChartLabelItemTemplateProperty =
            DependencyProperty.Register("PieChartLabelItemTemplate", typeof(DataTemplate), typeof(LabeledPieChart), new PropertyMetadata(null));
        ...
        {
            PieSeries pieSeries = this.GetTemplateChild("PieSeries") as PieSeries;
            if (pieSeries != null)
            {
